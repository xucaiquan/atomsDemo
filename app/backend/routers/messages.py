...
async def query_messagess(
    ...
    """Query messagess with filtering, sorting, and pagination"""
    ...
    try:
        ...
        logger.warning(f"Invalid messages query: {str(e)}")
...
async def update_messagess_batch(
    ...
    """Update multiple messagess in a single request"""
...
async def delete_messagess_batch(
    ...
    """Delete multiple messagess by their IDs"""
...
async def delete_messages(
    ...
    """Delete a single messages by ID"""
